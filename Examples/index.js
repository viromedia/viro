...
var ARTests = [
  ...
  { name: 'ARPostProcessTest', scene: require('./js/AR/release_test/ViroPostProcessTestAR') },
];
var VRTests = [
  ...
  { name: 'PbrBallTest', scene: require('./js/release_test/ViroPbrBallTest') },
  { name: 'PbrTest', scene: require('./js/release_test/ViroPbrTest') },
  { name: 'PbrTestSurfaces', scene: require('./js/release_test/ViroPbrTestSurfaces') },
  { name: 'PivotTest', scene: require('./js/release_test/ViroPivotTest') },
  ...
  { name: 'PortalTest', scene: require('./js/release_test/ViroPortalTest') },
