 ...
 *//**
 ...
 var ViroNodeTest = require('./ViroNodeTest');
 ...
 var ViroOmniLightTest = React.createClass({
   ...
   render: function() {
     return (
      ...
      <Viro360Image
       ...
       <ViroText text="ViroOmniLight" position={[0, -5, -3]} transformBehaviors={["billboard"]} />
   ...
   _showNext() {
     this.props.sceneNavigator.push({scene:ViroOrbitCameraTest});
   },
 ...
 module.exports = ViroOmniLightTest;
