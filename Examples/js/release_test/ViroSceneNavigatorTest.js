 ...
 *//**
 ...
 var ViroOrbitCameraTest = require('./ViroOrbitCameraTest');
 var ViroSceneTest = require('./ViroSceneTest');

 // **This test has not been done.  This is placeholder for scene and navigation arrows**

 var ViroSceneNavigatorTest = React.createClass({
   ...
   render: function() {
     return (
      ...
      <Viro360Image
       ...
       <ViroText text="ViroSceneNavigator" position={[0, -5, -3]} transformBehaviors={["billboard"]} />
   ...
   _showNext() {
     this.props.sceneNavigator.push({scene:ViroSceneTest});
   },
 ...
 module.exports = ViroSceneNavigatorTest;
