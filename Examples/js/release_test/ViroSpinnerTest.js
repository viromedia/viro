 ...
 *//**
 ...
 var ViroSpotLightTest = require('./ViroSpotLightTest');

 // **This test has not been done.  This is placeholder for scene and navigation arrows**

 var ViroSpinnerTest = React.createClass({
   ...
   render: function() {
     return (
      ...
      <Viro360Image
       ...
       <ViroText text="ViroSpinner" position={[0, -5, -3]} transformBehaviors={["billboard"]} />
   ...
   _showNext() {
     this.props.sceneNavigator.push({scene:ViroSpotLightTest});
   },
 ...
 module.exports = ViroSpinnerTest;
