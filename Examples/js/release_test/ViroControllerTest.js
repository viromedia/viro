...
var ViroCameraTest = require('./ViroCameraTest');
var ViroDirectionalLightTest = require('./ViroDirectionalLightTest');

var ViroControllerTest = React.createClass({
  ...
  render: function() {
    return (
     ...
     <Viro360Image
      ...
      <ViroText text="ViroController" position={[0, -5, -3]} transformBehaviors={["billboard"]} />
  ...
  _showNext() {
    this.props.sceneNavigator.push({scene:ViroDirectionalLightTest});
  },
...
module.exports = ViroControllerTest;
