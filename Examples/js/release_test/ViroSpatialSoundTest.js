 ...
 *//**
 ...
 var ViroSoundTest = require('./ViroSoundTest');
 var ViroSphereTest = require('./ViroSphereTest');

 // **This test has not been done.  This is placeholder for scene and navigation arrows**

 var ViroSpatialSoundTest = React.createClass({
   ...
   render: function() {
     return (
      ...
      <Viro360Image
       ...
       <ViroText text="ViroSpatialSoundTest" position={[0, -5, -3]} transformBehaviors={["billboard"]} />
   ...
   _showNext() {
     this.props.sceneNavigator.push({scene:ViroSphereTest});
   },
 ...
 module.exports = ViroSpatialSoundTest;
