 ...
 *//**
 ...
 var ViroSceneTest = React.createClass({
   ...
   render: function() {
     return (
      ...
      <Viro360Image
       ...
       <ViroText text="ViroScene" position={[0, -5, -3]} transformBehaviors={["billboard"]} />
   ...
   _showNext() {
     this.props.sceneNavigator.push({scene:ViroSkyBoxTest});
   },
