 ...
 *//**
 ...
 var ViroOmniLightTest = require('./ViroOmniLightTest');
 var ViroSceneNavigatorTest = require('./ViroSceneNavigatorTest');

 // **This test has not been done.  This is placeholder for scene and navigation arrows**

 var ViroOrbitCameraTest = React.createClass({
   ...
   render: function() {
     return (
      ...
      <Viro360Image
       ...
       <ViroText text="ViroOrbitCamera" position={[0, -5, -3]} transformBehaviors={["billboard"]} />
   ...
   _showNext() {
     this.props.sceneNavigator.push({scene:ViroSceneNavigatorTest});
   },
 ...
 module.exports = ViroOrbitCameraTest;
