 ...
 *//**
 ...
 var ViroSurfaceTest = React.createClass({
   ...
   render: function() {
     return (
      ...
      <Viro360Image
       ...
       <ViroText text="ViroSurface" position={[0, -5, -3]} transformBehaviors={["billboard"]} />
   ...
   _showNext() {
     this.props.sceneNavigator.push({scene:ViroTextTest});
   },
 ...
 module.exports = ViroSurfaceTest;
