 ...
 *//**
 ...
 var ViroSurfaceTest = require('./ViroSurfaceTest');
 ...
 var ViroSpotLightTest = React.createClass({
   ...
   render: function() {
     return (
      ...
      <Viro360Image
       ...
       <ViroText text="ViroSpotLight" position={[0, -5, -3]} transformBehaviors={["billboard"]} />
   ...
   _showNext() {
     this.props.sceneNavigator.push({scene:ViroSurfaceTest});
   },
