 ...
 *//**
 ...
 var ViroTextTest = require('./ViroSurfaceTest');
 ...
 var ViroVideoTest = React.createClass({
   ...
   render: function() {
     return (
      ...
      <Viro360Image
       ...
       <ViroText text="ViroVideo" position={[0, -5, -3]} transformBehaviors={["billboard"]} />
   ...
   _showNext() {
     this.props.sceneNavigator.push({scene:Viro3DObjectTest});
   },
