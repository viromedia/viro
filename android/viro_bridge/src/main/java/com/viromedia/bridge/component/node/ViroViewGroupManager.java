 ...
 *
 * IMPORTANT NOTE: Always extend from this class for all Viro Group Managers to bypass Android specific
 * required prop types. This is so as to prevent any clashes between Android props and Viro props.
 *
